...
(5) is a string different from both (3) and (4), and is the code required to register a super-admin account (every privilege an admin has plus the ability to remove all regular users in one action)
