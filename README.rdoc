...
(3) is some string, which is the code required to register a regular account
(4) is a string different from (3), which is the code required to register an admin account
The first 4 lines are environment variables required for password-recovery-emails to work.
The last 2 lines are environment variables required for anything to work.
