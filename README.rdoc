...
After navigating to main directory of repo, run the following command:
...
The first 4 lines are environment variables required for password-recovery-emails to work. The last 3 lines are environment variables required for anything to work.
...
After adding your heroku app to the repo, and navigating to the main directory of repo, run the following commands:
